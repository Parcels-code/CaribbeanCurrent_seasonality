...
- `3_calc_Eulerian_monthly_and_wavelet.py`: calculate geostrophic flow from SSH, define EDDY/NW-flow regimes, compute monthly statistics and wavelet analysis, and create **Figure 4** from the manuscript
...
Name of the Parcels simulation is: **GRENAVENE** (based on release location of the particles at Grenada-Venezuela cross-section).
...
- `3_run_GRENAVENE.py`: run Parcels simulation called GRENAVENE in parallel (using slurm)
...
Wind speed data were obtained from the product Global Ocean Hourly Reprocessed Sea Surface Wind and Stress from Scatterometer and Model, provided by the E.U. Copernicus Marine Service, covering the period from 1 June 1994 to 31 December 2024. The data was downloaded at https://doi.org/10.48670/moi-00185
...
## Combining integrated spectra across analyses
